...
//         if (response.ok) {
//   login(data.token, data); // ✅ pass user data too
//   localStorage.setItem("role", data.role);
...
const LoginForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // ✅ Normalize role to uppercase (backend sends "USER"/"ADMIN")
        ...
        // ✅ Pass token to AuthContext for global use
        login(data.token, data);
  ...
  // ======================================================
  // 🎨 Inline Styles (Preserved Original Design)
  // ======================================================
  const styles = {
    box: {
      position: "relative",
